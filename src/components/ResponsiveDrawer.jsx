  ...
  const drawer = (
    <div className='bg-[#313a41] h-full text-white relative'>
              <div style={{position:"absolute" ,top:"0",width:"100%", marginLeft:"4px",marginTop:"30px",height:"50px"}}>
                <h1>Notes</h1>
                <button style={{position:"absolute", top:"10px", right:"10px", padding:"5px 10px", borderRadius:"5px", backgroundColor:"#202833",color:"white", border:"none", cursor:"pointer"}} onClick={() => alert('Add new note')}>+</button>  
             </div>
